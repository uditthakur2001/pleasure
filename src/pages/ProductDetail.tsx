...
const ProductDetail = () => {
  ...
  const loadProduct = async () => {
    ...
    const firstVariantWithImages = data.variants?.find(
      (v: any) => v.images?.length > 0,
    );

    setSelectedVariant(firstVariantWithImages || null);
      ...
      <section className="container-prose grid gap-12 py-12 lg:grid-cols-2 lg:py-16">
        <div className="relative flex flex-col items-start gap-8 lg:flex-row">
          <div className="space-y-4">
            ...
            >
              <img
                src={currentImages?.[selected] || "/placeholder.webp"}
                alt={product.name}
        ...
        <div>
          ...
          {product.description && (
            <div className="mt-6">
              <h2 className="font-display text-xl text-primary">Description</h2>
          ...
          <div className="mt-8 space-y-6">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2">
                {product.indications?.map((i: string) => (
      ...
      <Suspense fallback={null}>
        {openLightbox && (
          <Lightbox
            ...
            slides={currentImages?.map((img: string) => ({
              src: img,
            }))}
            index={selected}
            plugins={[Zoom]}
