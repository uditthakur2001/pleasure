...
export const ProductCard = memo(({ product }: ProductCardProps) => (
  ...
  >
    <div className="relative aspect-[4/3] overflow-hidden bg-[#faf1e5] flex items-center justify-center">
      <img
    ...
    <div className="flex flex-1 flex-col gap-2 p-5">
      <h3 className="font-display text-2xl text-primary">{product.name}</h3>
