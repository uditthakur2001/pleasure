        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/80">
            ...
            <li className="flex gap-3">
              ...
              <a href="tel:+91 9927764596" className="hover:text-primary-foreground">+91 9927764596</a>
              <a href="tel:+91 9149216396" className="hover:text-primary-foreground">+91 9149216396</a>
            </li>
          </ul>
        </div>
      </div>
