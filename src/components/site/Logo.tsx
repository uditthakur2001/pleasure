...
export const Logo = ({
  ...
  return (
    ...
    >
      {/* <span className="grid h-10 w-10 place-items-center rounded-md bg-primary text-primary-foreground shadow-soft transition-smooth group-hover:bg-primary-glow">
      ...
      <span className="grid h-10 w-10 place-items-center rounded-md  text-primary-foreground shadow-soft transition-smooth group-hover:bg-primary-glow">
        <img src="/pleasaure logo.svg" alt="logo" className="h-10 w-10" />
      </span>
